...
export const CRAB_V2_ADDR =
  dataSource.network() == "ropsten"
    ? Address.fromString("0xdD1e9c25115e0d6e531d9F9E6ab7dbbEd15158Ce")
    : Address.fromString("0x3B960E47784150F5a63777201ee2B15253D713e8");

export const CRAB_MIGRATION_ADDR =
  dataSource.network() == "ropsten"
    ? Address.fromString("0xD0fb9d47B5F65d76C6bDf1b9E43a4A2345080B2f")
    : Address.fromString("0xa1cab67a4383312718a5799eaa127906e9d4b19e");

export const CRAB_V1_ADDR =
  dataSource.network() == "ropsten"
    ? Address.fromString("0xbffBD99cFD9d77c49595dFe8eB531715906ca4Cf")
    : Address.fromString("0xf205ad80bb86ac92247638914265887a8baa437d");
