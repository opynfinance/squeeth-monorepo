describe('Metamask', () => {
  context('Test commands', () => {
    ...
    it(`acceptMetamaskAccess should accept connection request to metamask`, () => {
      ...
      cy.get('#accounts').contains('0x352e559b06e9c6c72edbf5af2bf52c61f088db71')
    })
    ...
    it(`importMetamaskAccount should import new account using private key`, () => {
      cy.importMetamaskAccount('69270203c33d9d54ffd9cfcd9be01a12259a6efe968db9f1d5728717a9ab9a17').then((imported) => {
    ...
    it(`confirmMetamaskSignatureRequest should confirm signature request`, () => {
      ...
      cy.get('#personalSignVerifySigUtilResult').contains('0x352e559b06e9c6c72edbf5af2bf52c61f088db71')
    })
