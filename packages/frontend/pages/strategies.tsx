        ...
        {selectedIdx === 0 ? ( //bull vault
          ...
          <div>
            ...
            <Typography variant="subtitle1" color="textSecondary" style={{ width: '60%', marginTop: '8px' }}>
              ...
              USD terms, stacking ETH during price drops, and selling ETH when price increases. You earn funding without taking any view on if ETH will move up or down.
