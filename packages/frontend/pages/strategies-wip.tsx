...
//           <a style={{ color: '#4DADF3' }} href={Links.GitBook} target="_blank" rel="noreferrer">
//             {' '}
//             Learn more.{' '}
//           </a>
//         </p>
...
//   const dailyInterestRate = useMemo(() => (fundingPerHalfHour * 100) / price, [fundingPerHalfHour, price])
