      ...
      <div className={classes.container}>
        ...
        <Box marginTop="60px">
          ...
          <Typography variant="subtitle1" className={clsx(classes.content, classes.fontColorBody)}>
            The Calm Bull Strategy contains a short squeeth and an ETH leverage position. If the strategy falls below
            the safe collateralization threshold ({shortSqueethPosition} on the short squeeth position and{' '}
            ...
            <br /> <br />
            Based on current premiums, calm bull strategy would only be stacking ETH if ETH stays within ETH stays
            within around {ethPriceDown}-{ethPriceUp} before the next rebalance. The implied premium which you deposit
            at impacts your profitability. Depositing at a higher premium than expected increases likelihood of
            profitability.
            <br /> <br />
            If the Squeeth premium increases, it will be more expensive to close your position. Calm bull aims to be
            ...
            <br /> <br />
            Calm bull smart contracts have been audited by Open Zeppelin. However, smart contracts are experimental
