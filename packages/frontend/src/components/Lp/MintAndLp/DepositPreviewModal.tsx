...
import { Modal, Box, Typography, Divider, InputAdornment } from '@material-ui/core'
  ...
  return (
    <Modal open={isOpen} onClose={onClose} aria-labelledby="modal-title">
      <Box className={classes.container}>
        ...
        <Box marginTop="32px">
          <PrimaryButton id="confirm-deposit-btn" fullWidth={true} className={buttonClasses.primary} onClick={() => {}}>
            {'Confirm deposit'}
          </PrimaryButton>
        </Box>
      </Box>
