...
export enum BULL_EVENTS {
  ...
  WITHDRAW_BULL_RECOVERY_AMOUNT_ENTERED = 'WITHDRAW_BULL_RECOVERY_AMOUNT_ENTERED',
  WITHDRAW_BULL_RECOVERY_CLICK = 'WITHDRAW_BULL_RECOVERY_CLICK',
  WITHDRAW_BULL_RECOVERY_SUCCESS = 'WITHDRAW_BULL_RECOVERY_SUCCESS',
  WITHDRAW_BULL_RECOVERY_FAILED = 'WITHDRAW_BULL_RECOVERY_FAILED',
  WITHDRAW_BULL_RECOVERY_REVERT = 'WITHDRAW_BULL_RECOVERY_REVERT',
  APPROVE_WITHDRAW_BULL_RECOVERY = 'APPROVE_WITHDRAW_BULL_RECOVERY',
  WITHDRAW_BULL_RECOVERY_WRONG_GAS = 'WITHDRAW_BULL_RECOVERY_WRONG_GAS',
  WITHDRAW_BULL_RECOVERY_SET_AMOUNT_MAX = 'WITHDRAW_BULL_RECOVERY_SET_AMOUNT_MAX',
  WITHDRAW_BULL_RECOVERY_CHANGE_SLIPPAGE = 'WITHDRAW_BULL_RECOVERY_CHANGE_SLIPPAGE',
}
