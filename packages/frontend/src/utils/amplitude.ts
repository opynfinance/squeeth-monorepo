...
export enum BULL_EVENTS {
  ...
  DEPOSIT_STN_BULL_CLICK = 'DEPOSIT_STN_BULL_CLICK',
  DEPOSIT_STN_BULL_SUCCESS = 'DEPOSIT_STN_BULL_SUCCESS',
  DEPOSIT_STN_BULL_REVERT = 'DEPOSIT_STN_BULL_REVERT',
  DEPOSIT_STN_BULL_FAILED = 'DEPOSIT_STN_BULL_FAILED',
  CANCEL_DEPOSIT_STN_BULL_CLICK = 'CANCEL_DEPOSIT_STN_BULL_CLICK',
  CANCEL_DEPOSIT_STN_BULL_SUCCESS = 'CANCEL_DEPOSIT_STN_BULL_SUCCESS',
  CANCEL_DEPOSIT_STN_BULL_REJECT = 'CANCEL_DEPOSIT_STN_BULL_REJECT',
  CANCEL_DEPOSIT_STN_BULL_FAILED = 'CANCEL_DEPOSIT_STN_BULL_FAILED',
  WITHDRAW_STN_BULL_CLICK = 'WITHDRAW_STN_BULL_CLICK',
  WITHDRAW_STN_BULL_SUCCESS = 'WITHDRAW_STN_BULL_SUCCESS',
  WITHDRAW_STN_BULL_REVERT = 'WITHDRAW_STN_BULL_REVERT',
  WITHDRAW_STN_BULL_FAILED = 'WITHDRAW_STN_BULL_FAILED',
  CANCEL_WITHDRAW_STN_BULL_CLICK = 'CANCEL_WITHDRAW_STN_BULL_CLICK',
  CANCEL_WITHDRAW_STN_BULL_SUCCESS = 'CANCEL_WITHDRAW_STN_BULL_SUCCESS',
  CANCEL_WITHDRAW_STN_BULL_REJECT = 'CANCEL_WITHDRAW_STN_BULL_REJECT',
  CANCEL_WITHDRAW_STN_BULL_FAILED = 'CANCEL_WITHDRAW_STN_BULL_FAILED',
  USER_FORCE_INSTANT_DEP_BULL = 'USER_FORCE_INSTANT_DEP_BULL',
  USER_FORCE_INSTANT_WIT_BULL = 'USER_FORCE_INSTANT_WIT_BULL',
  APPROVE_WITHDRAW_BULL = 'APPROVE_WITHDRAW_BULL',
  APPROVE_WITHDRAW_STN_BULL = 'APPROVE_WITHDRAW_STN_BULL',
