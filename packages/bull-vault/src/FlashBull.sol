...
>>>>>>> b27a3c2c79d8943e92b0c323442d963b13ac8bb7
// interface
...
contract FlashBull is UniBull {
    ...
    function flashDeposit(uint256 _totalEthToBull, uint256 _ethToCrab, uint24 _poolFee) external payable {
        ...
        uint256 wPowerPerpToMint;
        {
            ...
            (ethToLend, usdcToBorrow) = IBullStrategy(bullStrategy).calcLeverageEthUsdc(crabAmount, share, crabUsdPrice, ethUsdPrice);
        }
