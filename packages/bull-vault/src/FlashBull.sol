...
contract FlashBull is UniFlash {
     ...
     */
    function flashDeposit(uint256 _ethToCrab, uint256 _minEthFromSqth, uint256 _minEthFromUsdc, uint24 _poolFee)
        external
        payable
    {
        uint256 crabAmount;
        ...
        uint256 squeethInCrab;
        {
            ...
            uint256 ethFee;
            uint256 squeethEthPrice = UniOracle._getTwap(ethWSqueethPool, wPowerPerp, weth, TWAP);
