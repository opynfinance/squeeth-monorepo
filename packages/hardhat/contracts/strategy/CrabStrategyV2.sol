 ...
 * @author Opyn team
 */
contract CrabStrategyV2 is StrategyBase, StrategyFlashSwap, StrategySwap, ReentrancyGuard, Ownable, EIP712 {
    ...
    function _flashWithdraw(
        ...
        _exactOutFlashSwap(
            ...
            abi.encode(_crabAmount, _withdrawEth, _fee, _tokenOut, _minAmountOut)
        );
