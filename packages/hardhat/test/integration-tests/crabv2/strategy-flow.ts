...
import { WETH9, MockErc20, Controller, Oracle, WPowerPerp, CrabStrategyV2, MockTimelock } from "../../../typechain";
...
describe("Crab V2 integration test: flash deposit - deposit - withdraw", function () {
  ...
  this.beforeAll("Deploy uniswap protocol & setup uniswap pool", async () => {
    ...
    crabStrategy = (await CrabStrategyContract.deploy(controller.address, oracle.address, weth.address, uniswapFactory.address, wSqueethPool.address, timelock.address, uniDeployments.swapRouter.address, hedgeTimeThreshold, hedgePriceThreshold, auctionTime, minPriceMultiplier, maxPriceMultiplier)) as CrabStrategyV2;
